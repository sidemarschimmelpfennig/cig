    ...
    public function run()
    {
        $users = [
            [
                ...
                'password_hash' => password_hash('admin_rest1', PASSWORD_DEFAULT),
            ...
            [
                'id_restaurant' => 1,
                'username' => 'user_rest1',
                'password_hash' => password_hash('user_rest1', PASSWORD_DEFAULT),
            ...
            [
                ...
                'password_hash' => password_hash('admin_rest2', PASSWORD_DEFAULT),
            ...
            [
                'id_restaurant' => 2,
                'username' => 'user_rest2',
                'password_hash' => password_hash('user_rest2', PASSWORD_DEFAULT),
            ...
            [
                ...
                'password_hash' => password_hash('admin_rest3', PASSWORD_DEFAULT),
            ...
            [
                'id_restaurant' => 3,
                'username' => 'user_rest3',
                'password_hash' => password_hash('user_rest3', PASSWORD_DEFAULT),
        ...
        echo PHP_EOL . 'Inseridos ' . count($users) . 'usuarios' . PHP_EOL;
